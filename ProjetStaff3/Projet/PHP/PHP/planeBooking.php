<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        function create_booking($plane_id, $user_id, $rental_date, $rental_time, $base) {
            $stmt = $base->prepare("INSERT INTO Bookings (plane_id, user_id, rental_date, rental_time) VALUES (:plane_id, :user_id, :rental_date, :rental_time)");
            $stmt->bindParam(':plane_id', $plane_id);
