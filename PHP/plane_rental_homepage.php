...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="../Img_log/aircraft__1_-removebg-preview.png" type="image/x-icon">
        <title>Home</title>
    ...
    <body>
            ...
            <nav class="navbar">
                <div class="container">
                    ...
                    <ul class="nav-links">
                        ...
                        <li><a href="plane_rental_homepage.php">Plan Rental</a></li>
                        <!-- <li><a href="Fleet.php">Our Fleet 1</a></li> -->
                        <li><a href="aircraft.php">Our Fleet </a></li>
        ...
        <section class="section">
            ...
            <div class="form-container">
                ...
                <div class="booking-form show" id="rental-plane-form">
                    <h2>Rent a Plane</h2>
        ...
        <section class="about-us">
            <a href="aircraft.php" ><button>See our fleet</button></a>
        </section>
