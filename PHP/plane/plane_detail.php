...
<html lang="en">
    ...
    <main>
        ...
        <?php
            // Include necessary files (e.g., database connection, header, etc.)
            // include 'db_connect.php'; // Assuming this is your database connection script
            // include 'header.php'; // Include your header

            // Fetch the plane ID from the URL parameter
